...
#ifndef __APPLICATIONPACKETS_M_H
#define __APPLICATIONPACKETS_M_H
...
/**
 * Class generated from <tt>ApplicationPackets.msg:1</tt> by opp_msgtool.
 * <pre>
 * packet DataPacket
 * {
 *     simtime_t genTime; //generazione pacchetto
 *     //dato che stiamo trasmettendo un burst ci interessa sapere
 *     //qual è l'ultimo pacchetto
 *     bool lastBurstPacket = false;
 * 	//lunghezza?
 * 	//dobbiamo crearci un messaggio che contenga le informazioni
 * 	//per i livelli sottostanti
 * }
 * </pre>
 */
...
/**
 * Class generated from <tt>ApplicationPackets.msg:11</tt> by opp_msgtool.
 * <pre>
 * message DataControlInfo
 * {
 *     //name = "DataControlInfo";
 *     string destination;
 * }
 * </pre>
 */
...
#endif // ifndef __APPLICATIONPACKETS_M_H
